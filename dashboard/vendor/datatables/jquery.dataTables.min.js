...
(function(h) {
    ...
    function Ka(a, b, c, d) {
        var e = [],
            ...
            q = a._rowReadObject,
            d = d !== k ? d : q ? {} : [],
            s = function(a, b) { if ("string" === typeof a) { var c = a.indexOf("@"); - 1 !== c && (c = a.substring(c + 1), N(a)(d, b.getAttribute(c))) } },
            G = function(a) {
    ...
    function wb(a) {
        ...
        var s = function(a, b) { j.push({ name: a, value: b }) };
        s("sEcho", a.iDraw);
        s("iColumns", c);
    ...
    function Ha(a) {
        ...
        if (d || !s && !f && !e && j == W(a) && j == n.length)
            ...
            if (a.aoData.length)
                for (l = 0; l < i.length; l++) s = i[l], o = c[s], h(Hb(a, s)).clone(!1).append(o.sContentPadding).appendTo(r);
    ...
    function K(a, b, c, d) {
        ...
        else if (b = l.ext, b = b.sErrMode || b.errMode, a && t(a, null, "error", [a, d, c]), "alert" == b) alert(c);
    ...
    var l = function(a) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    for (i = s.length; j < i; j++) {
                        var o = s[j];
                        if (o.nTable ==
                            this || o.nTHead && o.nTHead.parentNode == this || o.nTFoot && o.nTFoot.parentNode == this) { var r = g.bRetrieve !== k ? g.bRetrieve : m.bRetrieve; if (c || r) return o.oInstance; if (g.bDestroy !== k ? g.bDestroy : m.bDestroy) { o.oInstance.fnDestroy(); break } else { K(o, 0, "Cannot reinitialise DataTable", 3); return } }
                        if (o.sTableId == this.id) { s.splice(j, 1); break }
                    }
                    ...
                    kb(p, g.aoColumnDefs, s, function(a, b) { la(p, a, b) });
                    if (v.length) {
        ...
        Qb = function(a, b) { $a[b] || ($a[b] = RegExp(Sa(b), "g")); return "string" === typeof a && "." !== b ? a.replace(/\./g, "").replace($a[b], ".") : a },
        ab = function(a, b, c) {
    ...
    var A = function(a, b, c) { a[b] !== k && (a[c] = a[b]) },
        ...
        dc = function(a) {
            ...
            if (a) {
                ...
                if (a.nodeName && a.nodeName.toLowerCase() === "table") { b = h.inArray(a, e); return b !== -1 ? [d[b]] : null }
    ...
    var Vb = function(a, b) {
        if (Array.isArray(a)) return h.map(a, function(a) { return Vb(a, b) });
        if (typeof a === "number") return [b[a]];
        var c = h.map(b, function(a) { return a.nTable });
    ...
    o("tables()", function(a) { return a !== k && a !== null ? new r(Vb(a, this.context)) : this });
    o("table()", function(a) {
        var a = this.tables(a),
            b = a.context;
        ...
        var b = cb(b),
            c = this.iterator("table", function(c) {
                ...
                return bb("row", a, function(a) {
                        ...
                        if (typeof a ===
                            "function") return h.map(f, function(b) { var c = i[b]; return a(b, c._aData, c.nTr) ? b : null });
                        if (a.nodeName) {
    ...
    o("rows().nodes()", function() { return this.iterator("row", function(a, b) { return a.aoData[b].nTr || k }, 1) });
    o("rows().data()", function() { return this.iterator(true, "rows", function(a, b) { return ka(a.aoData, b, "_aData") }, 1) });
    u("rows().cache()", "row().cache()", function(a) { return this.iterator("row", function(b, c) { var d = b.aoData[c]; return a === "search" ? d._aFilterData : d._aSortData }, 1) });
    ...
    o(["row().child.remove()", "row().child().remove()"],
        function() { eb(this); return this });
    o("row().child.isShown()", function() { var a = this.context; return a.length && this.length ? a[0].aoData[this[0]]._detailsShow || false : false });
        ...
        var b = cb(b),
            c = this.iterator("table", function(c) {
                ...
                return bb("column", e, function(a) {
                    ...
                    if (typeof a === "function") { var e = Da(c, f); return h.map(g, function(b, f) { return a(f, Yb(c, f, 0, 0, e), i[f]) ? f : null }) }
    ...
    u("columns().data()",
        "column().data()",
        function() { return this.iterator("column-rows", Yb, 1) });
    u("columns().dataSrc()", "column().dataSrc()", function() { return this.iterator("column", function(a, b) { return a.aoColumns[b].mData }, 1) });
    u("columns().cache()", "column().cache()", function(a) { return this.iterator("column-rows", function(b, c, d, e, f) { return ka(b.aoData, f, a === "search" ? "_aFilterData" : "_aSortData", c) }, 1) });
    ...
    u("columns().indexes()", "column().index()", function(a) { return this.iterator("column", function(b, c) { return a === "visible" ? ca(b, c) : c }, 1) });
    ...
    u("cells().cache()", "cell().cache()", function(a) { a = a === "search" ? "_aFilterData" : "_aSortData"; return this.iterator("cell", function(b, c, d) { return b.aoData[c][a][d] }, 1) });
    ...
    u("cells().invalidate()", "cell().invalidate()", function(a) { return this.iterator("cell", function(b, c, d) { ea(b, c, a, d) }) });
    ...
    h.each(["on", "one", "off"], function(a, b) {
        o(b + "()", function() {
            ...
            a[0] =
                h.map(a[0].split(/\s/), function(a) { return !a.match(/\.dt\b/) ? a + ".dt" : a }).join(" ");
    ...
    l.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "Primeiro", sLast: "Anterior", sNext: "Proximo", sPrevious: "Anterior" },
            sEmptyTable: "No data available in table",
            sInfo: "A mostrar registos de _START_ a _END_ de _TOTAL_",
    ...
    $(l.defaults);
    l.defaults.column = { aDataSort: null, iDataSort: -1, asSorting: ["asc", "desc"], bSearchable: !0, bSortable: !0, bVisible: !0, fnCreatedCell: null, mData: null, mRender: null, sCellType: "td", sClass: "", sContentPadding: "", sDefaultContent: null, sName: "", sSortDataType: "std", sTitle: null, sType: null, sWidth: null };
    $(l.defaults.column);
    l.models.oSettings = {
        oFeatures: {
            bAutoWidth: null,
    ...
    h.extend(Mb, {
        ...
        full_numbers: function(a, b) { return ["first", "previous", ja(a, b), "next", "last"] },
        ...
        pageButton: {
            _: function(a, b, c, d, e, f) {
                var g = a.oClasses,
                    ...
                    s = function(b, d) {
                        ...
                        for (u = d.length; k <
                            ...
                            if (Array.isArray(r)) {
                                ...
                                if (l !== null) {
                                    t = h("<a>", { "class": g.sPageButton + " " + m, "aria-controls": a.sTableId, "aria-label": i[r], "data-dt-idx": o, tabindex: t, id: c === 0 && typeof r === "string" ? a.sTableId + "_" + r : null }).html(l).appendTo(b);
                                    Xa(t, { action: r }, w);
                                    o++
                                }
                            }
                    ...
                    u;
                try { u = h(b).find(H.activeElement).data("dt-idx") } catch (t) {}
                s(h(b).empty(), d);
    ...
    }, function(a, b) { var c = b.oLanguage.sDecimal; return ab(a, c, true) ? "num-fmt" + c : null }, function(a, b) { var c = b.oLanguage.sDecimal; return Rb(a, c) ? "html-num" + c : null }, function(a, b) { var c = b.oLanguage.sDecimal; return Rb(a, c, true) ? "html-num-fmt" + c : null }, function(a) { return M(a) || typeof a === "string" && a.indexOf("<") !== -1 ? "html" : null }]);
    ...
    h.extend(l.ext.internal, {
        ...
        _fnNodeToColumnIndex: function(a,
            b, c) { return h.inArray(c, a.aoData[b].anCells) },
        _fnGetCellData: B,
        _fnSetCellData: lb,
