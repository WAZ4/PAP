                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <div class="blog-comments">
                            ...
                            <div id="comment-2" class="comment">
                                ...
                                <div id="comment-new-reply-3" class="comment comment-reply">
                                    <div class="d-flex reply-form">
                                        <div class="w-100">
                                            <h4><span class="material-icons">north</span> Deixe a sua resposta</h4>
                                            <form action="">
                                                <div class="row mt-2">
                                                    <div class="col form-group">
                            ...
                            <div id="comment-4" class="comment">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5><a href="">Kay Duggan</a> <a href="#" class="reply" onclick="abrirComentario();"><i class="bi bi-reply-fill"></i> Reply</a></h5>
                                        <time datetime="2020-01-01">01 Jan, 2020</time>
                                        <p>
                                ...
                                <div id="comment-new-reply-3" class="comment comment-reply">
                                    <div class="d-flex reply-form">
                                        <div class="w-100">
                                            <h4><span class="material-icons">north</span> Deixe a sua resposta <a href="" onclick="fecharComentario();"><span class="material-icons float-end ">close</span></a></h4>
